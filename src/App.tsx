...
interface MyProps {
  ...
  // number:number,
  // resultData:{id:number,name:string,maths:number,physics:number,chemistry:number}[]
}
interface MyState {
  isLoggedIn : boolean,
...
function LoginButton(props:MyProps){
  return (
    <a href={props.href}>Login</a>
  );    
}

// function LogoutButton(props:MyProps){
//   return (
...
// function ToggleLoginButton(props:{onClick:()=>void}){
//   return (
//     <div>
//       <button style={{'backgroundColor':'blue'}} >Toggle Login</button>  
//     </div>
//   );
// }


// class LoginControl extends React.Component <MyProps, MyState> {
...
class Timer extends React.Component  <MyProps, {date:any}> {
  constructor(props:MyProps){
    super(props);
    this.state = {    
      date: new Date()
...
//   //   return (
//   //     <h3>You Have {props.number} unread messages</h3>
//   // );
//   // }
//   // return (
//   //     <h3>You Have no message to read</h3>
//   // );
//   return <h3>{props && props.number ? `You Have ${props.number} unread messages` : 'You Have no message to read'}</h3> 
// }

// class DashboardCounts extends React.Component <MyProps, MyState> {
    
//     render() {
      
//       const mails = ['email1','email2','email3'];
//       const messages = [];
//       const conditionalVariabl = ['1','',3];
...
//           {
//             conditionalVariabl.map((cv) =>
//                <ConditionalComponent number={cv}/>
//             )
//           }
//         </React.Fragment>
//       );
...
// class UsersResult extends React.Component <MyProps, MyState> {
...
// class EntryForm extends React.Component <MyProps, MyState> {
...
//             <label> Email:
//               <input type="email" ref={this.inputFocus} value={this.state.email} onChange={this.handleChange} name="email" />
//             </label>
//             <label> Password:
...
// class CheckPassingGrade extends React.Component <MyProps, MyState> {
//   constructor(props) {
//     super(props);
//     this.state = {
//       grade: 10,
...
// class TemperatureField extends React.Component <MyProps, MyState> {
...
// class TemperatureCalculator extends React.Component <MyProps, MyState> {
//     constructor(props) {
//       super(props);
//       this.state = {
//         temperature: '', 
...
// class Comment extends React.Component <MyProps, MyState> {
